...
public class TabFragmentA extends ListFragment {
	...
	// Array de Strings
	String[] arrayCod = { "001", "002", "003", "004", "005", "006", "007",
			"008", "009", "010" };

	String[] arraySabor = { "A Moda", "Atum", "Baiana", "Calabresa",
			"Frango Catupiry", "Marguerita", "Mussarela", "Portuguesa",
			"Quatro Queijos", "Toscana" };

	String[] arrayPreco = { "10,90", "11,90", "12,90", "13,90", "14,90",
			"15,90", "16,90", "17,90", "18,90", "19,90" };

	String[] arrayIngrediente = {
			"Ingredientes escolhidos a moda do cliente",
			"Molho de Tomate, Atum, Cebola e Azeitona",
			"Molho de Tomate, Calabresa moída, Cebola, Ovos cozidos, Pimenta e Azeitona",
			"Molho de Tomate, Calabresa fatiada, Cebola e Azeitona",
			"Molho de Tomate, Frango desfiado, Catupiry e Azeitona",
			"Molho de Tomate, Mussarela, Tomate, Manjericão e Azeitona",
			"Molho de Tomate, Mussarela, Orégano e Azeitona",
	...
	// ArrayList<HashMap<String, String>> pizzalist = new
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		SpecialAdapter adapter = new SpecialAdapter(getActivity(), pizzalist,
				R.layout.list_item, new String[] { TAG_SABOR, TAG_INGREDIENTE,
						TAG_PRECO }, new int[] { R.id.sabor, R.id.ingrediente,
						R.id.preco });
		setListAdapter(adapter);

		// Inflamos o layout tab_layout_a.xml
		// return (RelativeLayout) inflater.inflate(R.layout.tab_layout_a,
		// container, false);
